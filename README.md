...
**RUNNING THE CODE:**
First, make sure that you have R and RStudio downloaded on your computer:
...
*Investments by an Efficiency Program Administrator*
...
**Form EIA-923**
Form EIA-923 ("Power Plant Operations Report") provides data on the amount of generation from different plants in the U.S., the owners of the plant, and the fuel that the plant uses. 

In particular, we use the file that includes schedules 2, 3, 4, and 5 (e.g. "EIA923_Schedules_2_3_4_5_M_12_2021_Final.xlsx"). 
...
**Emissions Data**
The report also uses emissions data that comes from the EPA, but is aggregated by EIA and provided at https://www.eia.gov/electricity/data/emissions/. 
...
**Form EIA-860**
Form EIA-860 ("Annual Electric Generator Report") provides a crosswalk file to know what plants in the U.S. are owned by which utility. We use this information to match the plant numbers given in the emissions data with the utility that owns the plant. 
